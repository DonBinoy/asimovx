...
const Footer = () => {
    ...
    return (
        <footer className="bg-black pt-44 pb-20 px-6 md:px-24 border-t border-white/5">
            <div className="flex flex-col md:flex-row justify-between gap-24 mb-32">
                ...
                <div className="grid grid-cols-1 gap-16">
                    <div>
                        <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-white mb-8 block">{t('footer.contact')}</span>
                        <div className="space-y-6">
                            <div>
                                ...
                                <a href="tel:+46733205536" className="flex items-center gap-2 text-sm text-slate-400 hover:text-accent transition-colors mt-3">
                    ...
                    <div>
                        <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-white mb-8 block">{t('footer.network')}</span>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center border-t border-white/5 pt-12 text-[10px] font-bold tracking-[0.3em] uppercase text-slate-700">
